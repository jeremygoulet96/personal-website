...
<main>
    ...
    <ul class="work__list">
        ...
        <li class="work__item">
            <picture>
                <source class="work__image" srcset="./assets/images/work/iphone-x/hero.jpg 1x, ./assets/images/work/iphone-x/hero@2x.jpg 2x" type="image/jpeg" />
                <img class="work__image" src="./assets/images/work/iphone-x/hero.jpg" srcset="./assets/images/work/iphone-x/hero.jpg 1x, ./assets/images/work/iphone-x/hero@2x.jpg 2x" alt="iPhone X" />
            </picture>
